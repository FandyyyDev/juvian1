  ...
  console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32m Riy \x1b[1;37m]', time, chalk.green(budy || m.mtype), 'Dari', chalk.blue(pushname), 'Di', chalk.yellow(groupName ? groupName : 'Private Chat' ), 'args :', chalk.white(args.length))
  }
  ...
  await chika.setStatus(`🤖 ${botname} || 😈 Created By Juvian || ⏰ Runtime : ${runtime(process.uptime())}`);
  }
...
*${prefix}hapusabsen* - untuk menghapus absen`
  ...
  chika.sendMessage(m.chat, buttonMessageabsen)
  }
  break
  case 'hadir': {
  if (!m.isGroup) return reply(mess.group)
...
*${prefix}hapusabsen* - untuk menghapus absen`
  ...
  chika.sendMessage(m.chat, buttonMessagehadir)
  }
  break
  case 'tidakhadir': {
  if (!m.isGroup) return reply(mess.group)
...
*${prefix}hapusabsen* - untuk menghapus absen`
  ...
  chika.sendMessage(m.chat, buttonMessagetidakhadir)
  }
  break
  case 'cekabsen':
  if (!m.isGroup) return reply(mess.group)
...
© ${ownername}
`
  chika.sendTextWithMentions(m.chat, teks_absen, m)
  break
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
  ...
  let buttons = [ { buttonId: 'jadian', buttonText: { displayText: 'Jodohku' }, type: 1 } ]
  ...
  chika.send5ButImg(m.chat, data.result, `© ${ownername}`, imgtruth, btnstruth)
  break
  case 'dare':
  ...
  chika.send5ButImg(m.chat, data.result, `© ${ownername}`, imgdare, btnsdare)
  break
  case 'apakah':
...
*Pesan : ${q ? q : ''}*\n\n`
  ...
  await chika.sendButtonText(m.chat, buttons, `Mode Antilink`, ownername, fkontak)
  }
  }
  break
  case 'nsfw':
  ...
  let buttonsnsfw = [ { buttonId: `${command} on`, buttonText: { displayText: 'On' }, type: 1 } , { buttonId: `${command} off`, buttonText: { displayText: 'Off' }, type: 1 } ]
  await chika.sendButtonText(m.chat, buttonsnsfw, `Mode ${command}`, `© ${ownername}`, fkontak)
  }
  break
  case 'autoreact':
  if (!isCreator) return reply(mess.owner)
  if (args[0] === "on") {
  if (db.data.settings[botNumber].autoreact) return reply(`Sudah Aktif Sebelumnya`)
  db.data.settings[botNumber].autoreact = true
  reply(`Autoreact Berhasil Di Aktifkan !`)
  } else if (args[0] === "off") {
  if (!db.data.settings[botNumber].autoreact) return reply(`Sudah Nonaktif Sebelumnya`)
  db.data.settings[botNumber].autoreact = false
  reply(`Autoreact Berhasil Di Nonaktifkan !`)
  } else {
  let buttonsautoreact = [ { buttonId: `${command} on`, buttonText: { displayText: 'On ' }, type: 1 } , { buttonId: `${command} off`, buttonText: { displayText: 'Off' }, type: 1 }
  ]
  await chika.sendButtonText(m.chat, buttonsautoreact, `Mode ${command}`, `© ${ownername}`, m)
  }
  break
  case 'mute': {
  if (!m.isGroup) return reply(mess.group)
  ...
  if (!isBotAdmins) return reply(mess.botAdmin)
  if (!isAdmins) return reply(mess.admin)
  if (!q) return reply('Masukkan value enable/disable')
  if (args[0] === 'enable') {
  ...
  for (let i of anu) {
  await sleep(1500)
  let btn = [ { urlButton: { displayText: 'YouTube Creator' , url: `${youtube}` } } , { urlButton: { displayText: `Rest Api's`, url: `${myweb}` } }, { quickReplyButton: { displayText: 'Donasi', id: 'donasi' } } , { quickReplyButton: { displayText: 'Menu' , id: 'menu' } } ]
  ...
  chika.sendImageAsSticker(m.chat, teks, m, { packname: global.packname, author: global.author })
  })
  break
  case 'setwm': case 'wm': case 'takewm': {
  ...
  if (/image/.test(mime)) {
  let media = await quoted.download()
  let encmedia = await chika.sendImageAsSticker(m.chat, media, m, { packname: text.split("|")[0], author: text.split("|")[1] })
  await fs.unlinkSync(encmedia)
  } else if (/video/.test(mime)) {
  if ((quoted.msg || quoted).seconds > 11) return reply(`Kirim/Reply Gambar/Video Dengan Caption ${prefix + command}\n\nDurasi Sticker Video 1-9 Detik`)
  let media = await quoted.download()
  let encmedia = await chika.sendVideoAsSticker(m.chat, media, m, { packname: text.split("|")[0], author: text.split("|")[1] })
  await fs.unlinkSync(encmedia)
  } else {
  ...
  let buttonsnulis = [{buttonId: `thx`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(from, { caption: mess.done, image: buff , buttons: buttonsnulis, mentions: [m.sender] }).catch(err => {
  ...
  let buttonsnuliskiri = [{buttonId: `thx`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(from, { caption: mess.done, image: nuliskiri , buttons: buttonsnuliskiri, mentions: [sender] }).catch(err => {
  return reply(mess.error)
  })
  break   
  case 'nuliskanan':
  ...
  let buttonsnuliskanan = [{buttonId: `thx`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(from, { caption: mess.done, image: nuliskanan , buttons: buttonsnuliskanan, mentions: [m.sender] }).catch(err => {
  return reply(mess.error)
  })
  break   
  case 'foliokiri':
  ...
  let buttonsfoliokiri = [{buttonId: `thx`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(from, { caption: mess.done, image: foliokiri , buttons: buttonsfoliokiri, mentions: [m.sender] }).catch(err => {
  return reply(mess.error)
  })
  break   
  case 'foliokanan':
  ...
  let buttonsfoliokanan = [{buttonId: `thx`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(from, { caption: mess.done, image: foliokanan , buttons: buttonsfoliokanan, mentions: [m.sender] }).catch(err => {
  return reply(mess.error)
  })
  break   
  ...
  if (!/video/.test(mime) && !/audio/.test(mime)) return reply(`Kirim/Reply Video Yang Ingin Dijadikan Audio Dengan Caption ${prefix + command}`)
  ...
  break
  case 'tomp3': {
  if (/document/.test(mime)) return reply(`Kirim/Reply Video Yang Ingin Dijadikan Audio Dengan Caption ${prefix + command}`)
  if (!/video/.test(mime) && !/audio/.test(mime)) return reply(`Kirim/Reply Video Yang Ingin Dijadikan Audio Dengan Caption ${prefix + command}`)
  if (!q) return reply(`Kirim/Reply Video Yang Ingin Dijadikan Audio Dengan Caption ${prefix + command}`)
  reply(mess.wait)
  let media = await quoted.download()
  let { toAudio } = require('./lib/converter')
  let audio = await toAudio(media, 'mp4')
  ...
  break
  case 'tourl': {
  if (!q) return reply('Reply Image/Sticker/Video Yang Mau Dijadikan Url!')
  reply(mess.wait)
...
⭔ Url : ${anu.url}`,
 ...
 .catch((err) => {
  ...
  var but = [ { "urlButton": { "displayText": `Rest Api's` , "url": `${myweb}` } } ]
  await chika.send5ButImg(from, txt , `© ${ownername}`,gam, but , { userJid: m.chat, quoted: m })
  })
  .catch((err) => {
  reply(mess.error)
  })
  ...
  reply(mess.wait)
  let buttons = [ { buttonId: `coffe`, buttonText: { displayText: 'Next Image' } , type: 1 } ]
  let buttonMessage = { image: { url: 'https://coffee.alexflipnote.dev/random' }, caption: `☕ Random Coffe`,
  footer: ownername,
  buttons: buttons,
  headerType: 4
  }
  ...
  result = anu[Math.floor(Math.random() * anu.length)]
  let buttons = [ { buttonId: `wikimedia ${text}`, buttonText: {displayText: 'Next Image'}, type: 1 } ]
  let buttonMessage = { image: { url: result.image }, caption: `⭔ Title : ${result.title}\n⭔ Source : ${result.source}\n⭔ Media Url : ${result.image}`,
  footer: ownername,
  buttons: buttons,
  headerType: 4
  }
  ...
  teks = "*Darkjokes*"
  let butdrkjks = [{buttonId: `${command}`, buttonText: {displayText: 'Next Result'}, type: 1}]
  chika.sendMessage(m.chat, { image: { url: res }, caption: teks ,buttons: butdrkjks }, { quoted: m})
  break
  ...
  let buttonMessage = { text: `~_${result.quotes}_\n\nBy '${result.karakter}', ${result.anime}\n\n- ${result.up_at}`,
  footer: `© ${ownername}`,
  buttons: buttons,
  headerType: 2
  }
  ...
  reply(mess.wait)
  var data = await fetchJson(api('riy', `/api/random/${command}`, {}, 'apikey'))
  chika.sendButtonText(m.chat, [{ buttonId: `${command}`, buttonText: { displayText: 'Next' }, type: 1 }], `${data.result.quote}`, `© ${ownername}`, m)
  break 
  case 'katabijak':
  reply(mess.wait)
  var but = [{buttonId: `${command}`, buttonText: { displayText: "Next Result ⏭️" }, type: 1 }]
  var data = await fetchJson(api('riy', '/api/random/katabijak', {}, 'apikey'))
  chika.sendButtonText(m.chat, [{ buttonId: 'pantun', buttonText: { displayText: 'Next' }, type: 1 }], `${data.result}`, `© ${ownername}`, m)
  break
  ...
  await chika.sendButtonText(m.chat, btnfie, sari, `© ${ownername}`, m)
  break
  ...
  await chika.sendButtonText(m.chat, btnfiersa, ja, `© ${ownername}`, m)
  break
  ...
  await chika.sendButtonText(m.chat, btnbucin, cin, `© ${ownername}`, m)
  break
  case 'katailham': 
  ...
  chika.sendButtonText(m.chat, btnilham, hasil, `© ${ownername}`, m)
  })
  break
  case 'nomerhoki': case 'nomorhoki': {
  if (!Number(text)) return reply(`Example : ${prefix + command} 6281575886399`)
  ...
  var riyganteng = await getBuffer(picak+`Cerpen ${q}`)
  await chika.send5ButImg(from, `⭔ _*Title :*_ ${cerpe.title}\n⭔ _*Author :*_ ${cerpe.author}\n⭔ _*Category :*_ ${cerpe.kategori}\n⭔ _*Pass Moderation :*_ ${cerpe.lolos}\n⭔ _*Story :*_\n${cerpe.cerita}`, `© ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}}] )
  }
  break
    case 'infogempa':
  reply(mess.wait)
  ...
  case 'faktaunik':
  reply(mess.wait)
  var data = await fetchJson(api('riy', '/api/random/faktaunik', {}, 'apikey'))
  chika.sendButtonText(m.chat, [{ buttonId: 'faktaunik', buttonText: { displayText: 'NEXT ⏩' }, type: 1 }], `${data.result}`, `© ${ownername}`, m)
  break
...
© ${ownername}`
  ...
  chika.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m })
  break
  case 'fbdl': case 'fb': case 'facebookdl': case 'facebook':
  if (!q) return reply('Link Nya Mana?')
  if (!isUrl(q)) return reply('Link Nya Mana?')
  if (!q.includes('facebook')/('fb')) return reply('Itu Bukan Link Facebook!')
  await reply(mess.wait)
  chika.Facebook(`${q}`).then(async data => {
  let txt = `*🌱 FACEBOOK DOWNLOADER 🌱*\n\n`
  txt += `*💬 Judul :* ${data.title}\n`
  txt += `*📈 Resolusi :* ${data.medias[1].quality}\n`
  txt += `*📥 Ukuran :* ${data.medias[1].formattedSize}\n`
  txt += `*〽️ Url :* ${data.url}\n\n`
  txt += `*Done !!! Jangan Lupa Subscribe YT (Riy)*`
  ...
  if (!q) return reply('Link Nya Mana?')
  if (!isUrl(q)) return reply('Link Nya Mana?')
  if (!q.includes('instagram')) return reply('Itu Bukan Link Instagram!')
  await reply(mess.wait)
  ...
  if (i.extension === "mp4") {
  chika.sendMessage(from, { video: { url: i.url }})
  } else if (i.extension === "jpg") {
  chika.sendMessage(from, { image: { url: i.url }})
  }
  }
  })
  .catch((err) => {
  ...
  if (!q) return reply('Link Nya Mana?')
  if (!isUrl(q)) return reply('Link Nya Mana?')
  if (!q.includes('twitter')) return reply('Itu Bukan Link Twitter!')
  await reply(mess.wait)
  let imgtwt = await fetchJson(api('riy', '/api/download/twitterimg', { url: text }, 'apikey'))
  chika.sendMessage(m.chat, {image: { url: imgtwt.result }}, { quoted: m })
  .catch((err) => {
  reply(mess.error)
  })
  break
  ...
  if (!q.includes('twitter')) return reply('Itu Bukan Link Twitter!')
  await reply(mess.wait)
  let videotwt = await fetchJson(api('riy', '/api/download/twittervid', { url: text }, 'apikey'))
  chika.sendMessage(m.chat, {video: { url: videotwt.result }}, { quoted: m })
  .catch((err) => {
  reply(mess.error)
  })
  break
  ...
  await reply(mess.wait)
  let btn = [ { "quickReplyButton": { "displayText": "No Wm" , "id": `tiktoknowm ${q}` } }, { "quickReplyButton": { "displayText": "Wm","id": `tiktokwm ${q}` } }, { "quickReplyButton": { "displayText": "Audio", "id": `tiktokmp3 ${q}` } } ]
  fatihgans = await getBuffer(picak+'TIKTOK\nDOWNLOADER')
  let txt = `*Tiktok Download*\n\nSilahkan Pilih Jenis File Yang Di Inginkan\n`
  chika.send5ButImg(m.chat, txt, 'Jika Button Tidak Muncul Ketik Manual Saja', fatihgans, btn)
  .catch((err) => {
  reply(mess.error)
  })
  break
  ...
  if (!q.includes('tiktok')) return reply('Itu Bukan Link Tiktok!')
  await reply(mess.wait)
  let nowm= await fetchJson(api('riy', '/api/download/tiktok', { url: text }, 'apikey'))
  ...
  caption: mess.done+'\n\n*Jangan Lupa Subscribe Channel (Riy)*',
  footer: 'Klik Button Dibawah Jika Ingin Jenis Media Yang Lain',
  buttons: buttonswm,
  headerType: 5
  }
  chika.sendMessage(m.chat, buttonMessageWm, { quoted: m })
  .catch((err) => {
  reply(mess.error)
  })
  break
  ...
  if (!q.includes('tiktok')) return reply('Itu Bukan Link Tiktok!')
  await reply(mess.wait)
  let wm = await fetchJson(api('riy', '/api/download/tiktok', { url: q }, 'apikey'))
  ...
  chika.sendMessage(m.chat, buttonMessageNoWm, { quoted: m })
  .catch((err) => {
  reply(mess.error)
  })
  break
  ...
  if (!q.includes('tiktok')) return reply('Itu Bukan Link Tiktok!')
  await reply(mess.wait)
  let audiott = await fetchJson(api('riy', '/api/download/tiktok', { url: q }, 'apikey'))
  chika.sendMessage(m.chat, {audio: { url: audiott.result.audio }}, { quoted: m })
  .catch((err) => {
  reply(mess.error)
  })
  break
  ...
  let buttonMessage = { image: { url: anu.author.profilePic }, caption: `
⭔ Title : ${anu.title}
⭔ Author : ${anu.author.name}
⭔ Like : ${anu.like}
⭔ Caption : ${anu.caption}
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
  ...
  .then(({data}) => {
  sendFileFromUrl(m.chat, data.url, m, { packname: global.packname, author: global.author })
  })
  break
  ...
  .then(({data}) => {
  sendFileFromUrl(m.chat, data.url, mess.success, m)
  })
  break
  case 'yotsuba': case 'shinomiya': case 'yumeko': case 'tejina': case 'chiho': case 'toukachan': case 'akira': case 'itori': case 'kurumi': case 'miku': case 'pokemon': case 'ryujin': case 'kaori': case 'shizuka': case 'kotori': case 'kaga': case 'mikasa': case 'akiyama': case 'gremory': case 'isuzu': case 'shina': case 'kagura': case 'shinka': case 'eba': case 'deidara': case 'itachi': case 'madara': case 'yuki': case 'asuna': case 'ayuzawa': case 'chitoge': case 'emilia': case 'hestia': case 'inori': case 'ana': case 'boruto': case 'erza': case 'kakasih': case 'sagiri': case 'minato': case 'naruto': case 'nezuko': case 'onepiece': case 'sakura': case 'sasuke': case 'tsunade': case 'jhota': case 'hinata': {
  reply(mess.wait)
  const ranime= await getBuffer(api('riy', `/api/wallpaper/${command}`, {}, 'apikey'))
  let butranime = [{buttonId: `${command}`, buttonText: {displayText: 'Next Result'}, type: 1}]
  chika.sendMessage(m.chat, { image: ranime, caption: mess.success ,buttons: butranime }, { quoted: m})
  .catch((err) => {
  reply(mess.error)
  })
  }
  ...
  chika.sendImageAsSticker(m.chat, result, m, { packname: global.packname, author: global.author })
  break
  case 'gura':
  case 'gurastick':{
  ...
  reply(mess.wait)
  const nsfw = await getBuffer(api('riy', `/api/nsfw/${command}`, {}, 'apikey'))
  let buttonsnsfw = [{buttonId: `${command}`, buttonText: {displayText: 'Next Result'}, type: 1}]
  chika.sendMessage(m.chat, { image: nsfw, caption: `Sange? 🤨📸`,buttons: buttonsnsfw }, { quoted: m})
  .catch((err) => {
  reply(mess.error)
  })
  break
  ...
  reply(mess.wait)
  var data = await fetchJson(`https://api-riychdwayne.herokuapp.com/api/githubstalk?username=${text}&apikey=RiyGanz`)
  var github = `*GITHUB STALK 🔎*\n\n💞 Bio : ${data.result.bio}\n🏢 Perusahaan : ${data.result.company}\n📧 Email : ${data.result.email}\n👥 Followers : ${data.result.follower}\n🫂 Following : ${data.result.following}\n🗣️ Kategori : ${data.result.Type}\n\n© Riy`
  chika.sendMessage(m.chat, {caption: github, image: {url: data.result.avatar}}, {quoted: m})
  break
  ...
  let buttonsserti = [{buttonId: `thanks`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(m.chat, { image: serti, caption: mess.done, buttons: buttonsserti }, { quoted: m})
  break
  case 'magma': case '3dstone': case 'hallowen': case 'larva': 
  if(!text) return reply('Masukkan Teks')
  reply(mess.wait)
  const textpro = await getBuffer (`https://api-riychdwayne.herokuapp.com/apo/textpro/${command}?text=${text}&apikey=RiyGanz`)
  let btntextpro = [{buttonId: `thanks`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(m.chat, { image: textpro, caption: mess.done, buttons: btntextpro }, { quoted: m})
  break
  case 'blackpink':
  if(!text) return reply('Masukkan Teks')
  reply(mess.wait)
  const blck = await getBuffer(`https://api-riychdwayne.herokuapp.com/api/textpro/black-pink?text=${text}&apikey=RiyGanz`)
  let buttonblck = [{buttonId: `thanks`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(m.chat, { image: blck, caption: mess.done, buttons: buttonblck }, { quoted: m})
  break
  case 'neon':
  if(!text) return reply('Masukkan Teks')
  reply(mess.wait)
  const neon = await getBuffer(`https://api-riychdwayne.herokuapp.com/api/textpro/neon-light?text=${text}&apikey=RiyGanz`)
  let buttonsneon = [{buttonId: `thanks`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(m.chat, { image: neon, caption: mess.done, buttons: buttonsneon }, { quoted: m})
  break
  case 'horor': case 'horror':
  if(!text) return reply('Masukkan Teks')
  reply(mess.wait)
  const hor = await getBuffer(`https://api-riychdwayne.herokuapp.com/api/textpro/horor-blood?text=${text}&apikey=RiyGanz`)
  let buttonshor = [{buttonId: `thanks`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(m.chat, { image: hor, caption: mess.done, buttons: buttonshor }, { quoted: m})
  break
  case 'toxic':
  if(!text) return reply('Masukkan Teks')
  reply(mess.wait)
  const tox = await getBuffer(`https://api-riychdwayne.herokuapp.com/api/textpro/toxic-bokeh?text=${text}&apikey=RiyGanz`)
  let buttonstox = [{buttonId: `thanks`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(m.chat, { image: tox, caption: mess.done, buttons: buttonstox }, { quoted: m})
  break
  case 'marvel':
  if(!text) return reply('Masukkan Teks')
  ...
  atas = arg.split('|')[0]
  bawah = arg.split('|')[1]
  const mar = await getBuffer(`https://api-riychdwayne.herokuapp.com/api/textpro/marvel-logo2?text=${atas}&text2=${bawah}&apikey=RiyGanz`)
  let buttonsmar = [{buttonId: `thanks`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(m.chat, { image: mar, caption: mess.done, buttons: buttonsmar }, { quoted: m})
  break
  case 'potter':
  if(!text) return reply('Masukkan Teks')
  reply(mess.wait)
  const pot = await getBuffer(`https://api-riychdwayne.herokuapp.com/api/textpro/harry-potter?text=${text}&apikey=RiyGanz`)
  let buttonspot = [{buttonId: `thanks`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(m.chat, { image: pot, caption: mess.done, buttons: buttonspot }, { quoted: m})
  break
  case 'pornhub':
  if(!text) return reply('Masukkan Teks')
  if(!text.includes('|')) return reply(`Kirim Pesan Dengan Caption ${prefix + command} *teks|teks*`)
  ...
  atas = arg.split('|')[0]
  bawah = arg.split('|')[1]
  const porn = await getBuffer(`https://api-riychdwayne.herokuapp.com/api/textpro/pornhub?text=${atas}&text2=${bawah}&apikey=RiyGanz`)
  let buttonsporn = [{buttonId: `thanks`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(m.chat, { image: porn, caption: mess.done, buttons: buttonsporn }, { quoted: m})
  break
  ...
  chika.sendMessage(m.chat, { image: { url: poto }, caption: mess.done, buttons: buttonspoto }, { quoted: m })
  break
  ...
  let buttonspoto = [{buttonId: `thanks`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(m.chat, { image: getpoto, caption: mess.done, buttons: buttonspoto }, { quoted: m}) 
  break
  ...
  let buttonsphoto = [{buttonId: `thanks`, buttonText: {displayText: 'Makasih Bang 😎'}, type: 1}]
  chika.sendMessage(m.chat, { image: getphoto, caption: mess.done, buttons: buttonsphoto }, { quoted: m}) 
  break

  // Asupan
  case 'hijaber': case 'cecan': case 'bocil': case 'ukhty': case 'gheayubi': case 'rikagusriani': case 'santuy': {
  reply(mess.wait)
  const asupan = await getBuffer(api('riy', `/api/asupan/${command}`, {}, 'apikey'))
  let buttonsasupan = [{buttonId: `asupanhijaber`, buttonText: {displayText: 'Next Result'}, type: 1}]
  chika.sendMessage(m.chat, { video: asupan, caption: `Tobatlah Anak Muda 🗿`,buttons: buttonsasupan }, { quoted: m})
  .catch((err) => {
  reply(mess.error)
  })
  }
  ...
  reply(mess.wait)
  const cecan = await getBuffer(api('riy', `/api/cecan/${command}`, {}, 'apikey'))
  let buttonscecan = [{buttonId: `${command}`, buttonText: {displayText: 'Next Result'}, type: 1}]
  chika.sendMessage(m.chat, { image: cecan, caption: `Cakep Kan Pacar Saya 🤨📸`,buttons: buttonscecan }, { quoted: m})
  .catch((err) => {
  reply(mess.error)
  })
  break
  ...
  reply(mess.wait)
  chika.sendMessage(m.chat, {audio: inicdd, mimetype:'audio/mpeg', ptt:true }, {quoted:fvn})
  break
  ...
  typemenu = 'gif'
  reply("Sucses Mengganti All Menu "+q)
  }
  // Catalog
  else if (q == "catalog") {
  typemenu = 'catalog'
  ...
  break
  case 'command': {
  await chika.sendListMenu(from, `Selamat ${salam} kak ${pushname}` , lang.list(pushname) , `© ${ownername}`, 'CLICK HERE', {quoted: fkontak})
  }
  break
  case 'menu': {
  if(typemenu == 'image'){
  await chika.send5ButImg(from, `` + '' + lang.menu(botname, pushname, salam), `© ${ownername}`,thumb, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "List Command","id": 'command'}}] )
  }
  if(typemenu == 'gif'){
  await chika.send5ButGif(from, `` + '' + lang.menu(botname, pushname, salam), `© ${ownername}`,velochika, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "List Command","id": 'command'}}] )
  }
  if(typemenu == 'list'){
  ...
  case 'allmenu': {
  if(typemenu == 'image'){
  var riyganteng = await getBuffer(picak+'All Menu')
  await chika.send5ButImg(from, `` + '' + lang.allmenu(prefix, pushname, botname, time, salam), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Rules","id": 'rules'}}] )
  }
  if(typemenu == 'gif'){
  await chika.send5ButGif(from, `` + '' + lang.allmenu(prefix, pushname, botname, time, salam), `  © ${ownername}`,velochika, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Rules","id": 'rules'}}] )
  }
  if(typemenu == 'catalog'){
  ...
  break
  case 'botinfo':
  var riyganteng = await getBuffer(picak+'Bot Info')
  await chika.send5ButImg(from, `` + '' + lang.botinfo(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'ownermenu': case 'ownercmd':
  var riyganteng = await getBuffer(picak+'Owner Menu')
  await chika.send5ButImg(from, `` + '' + lang.ownermenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'groupmenu': case 'groupcmd':
  var riyganteng = await getBuffer(picak+'Group Menu')
  await chika.send5ButImg(from, `` + '' + lang.groupmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'databasemenu': case 'databasecmd':
  var riyganteng = await getBuffer(picak+'Database Menu')
  await chika.send5ButImg(from, `` + '' + lang.groupmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'searchmenu': case 'searchcmd':
  var riyganteng = await getBuffer(picak+'Search Menu')
  await chika.send5ButImg(from, `` + '' + lang.searchmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'downloadermenu': case 'downloadercmd':
  var riyganteng = await getBuffer(picak+'Downloader Menu')
  await chika.send5ButImg(from, `` + '' + lang.downloadermenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'convertermenu': case 'convertercmd':
  var riyganteng = await getBuffer(picak+'Converter Menu')
  await chika.send5ButImg(from, `` + '' + lang.convertermenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
 case 'textpromenu': case 'textprocmd':
  var riyganteng = await getBuffer(picak+'Textpro Menu')
  await chika.send5ButImg(from, `` + '' + lang.textpromenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'photooxymenu': case 'photooxycmd':
  var riyganteng = await getBuffer(picak+'Photo Oxy Menu')
  await chika.send5ButImg(from, `` + '' + lang.photooxymenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'ephotomenu360': case 'ephoto360':
  var riyganteng = await getBuffer(picak+'Ephoto360 Menu')
  await chika.send5ButImg(from, `` + '' + lang.ephotomenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'animemenu': case 'animecmd':
  var riyganteng = await getBuffer(picak+'Anime Menu')
  await chika.send5ButImg(from, `` + '' + lang.animemenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'nsfwmenu': case 'nsfwcmd':
  var riyganteng = await getBuffer(picak+'Nsfw Menu')
  await chika.send5ButImg(from, `` + '' + lang.nsfwmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'gamemenu': case 'gamecmd':
  var riyganteng = await getBuffer(picak+'Game Menu')
  await chika.send5ButImg(from, `` + '' + lang.gamemenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'funmenu': case 'funcmd':
  var riyganteng = await getBuffer(picak+'Fun Menu')
  await chika.send5ButImg(from, `` + '' + lang.funmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
    case 'primbonmenu': case 'primboncmd':
  var riyganteng = await getBuffer(picak+'Primbon Menu')
  await chika.send5ButImg(from, `` + '' + lang.primbonmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'cerpenmenu': case 'cerpencmd':
  var riyganteng = await getBuffer(picak+'Cerpen Menu')
  await chika.send5ButImg(from, `` + '' + lang.cerpenmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'informationmenu': case 'informationcmd':
  var riyganteng = await getBuffer(picak+'Information Menu')
  await chika.send5ButImg(from, `` + '' + lang.informationmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'cecanmenu': case 'cecancmd':
  var riyganteng = await getBuffer(picak+'Cecan Menu')
  await chika.send5ButImg(from, `` + '' + lang.cecanmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'asupanmenu': case 'asupancmd':
  var riyganteng = await getBuffer(picak+'Asupan Menu')
  await chika.send5ButImg(from, `` + '' + lang.asupanmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'islamicmenu': case 'islamiccmd':
  var riyganteng = await getBuffer(picak+'Islamic Menu')
  await chika.send5ButImg(from, `` + '' + lang.islamicmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'soundmenu': case 'soundcmd':
  var riyganteng = await getBuffer(picak+'Sound Menu')
  await chika.send5ButImg(from, `` + '' + lang.soundmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'voicechargermenu': case 'voicechargercmd':
  var riyganteng = await getBuffer(picak+'Voice Charger Menu')
  await chika.send5ButImg(from, `` + '' + lang.voicechargermenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'telegramstickermenu': case 'telegramstickercmd':
  var riyganteng = await getBuffer(picak+'Telegram Sticker Menu')
  await chika.send5ButImg(from, `` + '' + lang.telegramstickermenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'othersmenu': case 'otherscmd':
  var riyganteng = await getBuffer(picak+'Others Menu')
  await chika.send5ButImg(from, `` + '' + lang.othersmenu(prefix), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'sourcecode': case 'script': case 'sc':
  var riyganteng = await getBuffer(picak+'Source Code')
  await chika.send5ButImg(from, `*SOURCE CODE*\n\n${youtube}`, `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
  case 'donasi': case 'donate':
  var riyganteng = await getBuffer(picak+'Donasi')
  await chika.send5ButImg(from, `` + '' + lang.donasi(ownernomer), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "List Menu","id": 'command'}}] )
  break
  case 'thanksto': case 'tqto':
  var riyganteng = await getBuffer(picak+'Contributors')
  await chika.send5ButImg(from, `` + '' + lang.thanksto(), `  © ${ownername}`,riyganteng, [{"urlButton": {"displayText": "YouTube Creator","url": `${youtube}`}},{"urlButton": {"displayText": `Rest Api's`,"url": `${myweb}`}},{"quickReplyButton": {"displayText": "Donasi","id": 'donate'}},{"quickReplyButton": {"displayText": "Owner","id": 'owner'}},{"quickReplyButton": {"displayText": "Back To List","id": 'command'}}] )
  break
