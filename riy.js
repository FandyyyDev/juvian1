  ...
  browser: ['Bot By Juvian','Safari','1.0.0'],
  auth: state
  })
  ...
  let btnwel = [{buttonId: 'Juvian', buttonText: {displayText: 'Welcome Kak 👋'}, type: 1},]
  ...
  let btnbye = [{buttonId: 'Juvian', buttonText: {displayText: 'Goodbye Kak 👋'}, type: 1},]
